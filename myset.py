...
#myset.add(60)
#print(myset)
#if we want to add more item then we should go for update()
...
#union() this method will returnnewset
...
#here set compression is possible
#here indexing and scaling not possible on set object

#difference method() this will return the element present in myset but not in yorset
#clear( we can use to clear the data)